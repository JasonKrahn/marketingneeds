...
! function (t) {
    ...
    i.resize = S(u, _), i.scroll = S(u, "scroll.webflow resize.webflow orientationchange.webflow load.webflow"), i.redraw = S(), i.location = function (t) {
        window.location = t
    ...
    window.tram = function (t) {
        ...
        var T = e.frame = function () {
            ...
            C = l(function (e) {
                ...
                e.init = function (e) {
                    ...
                    q.backface && H.hideBackface && X(this.el, q.backface.css, "hidden")
            ...
            U = l(function (e) {
                function n() {
                    ...
                    if (r)
                        for (T(n), e = L(), t = r; t--;)(i = u[t]) && i.render(e)
                }
                var i = {
                    ease: f.ease[1],
                    from: 0,
                ...
                e.init = function (t) {
                    ...
                    var t;
                    this.active || (this.start || (this.start = L()), this.active = !0, t = this, 1 === u.push(t) && T(n))
                }, e.stop = function () {
                    var e, n, i;
        ...
        q.transform && (Y.transform = [N], K = {
            ...
            skewX: [k],
            skewY: [k]
        }), q.transform && q.backface && (K.z = [x, "translateZ"], K.rotateZ = [k], K.scaleZ = [b], K.perspective = [y]);
        var J = /ms/,
            Q = /s|\./;
        return t.tram = e
    }(window.jQuery)
    ...
    n(4), n(7), n(8), n(9), t.exports = n(10)
}, function (t, e, n) {
    "use strict";
    var i = n(0);
    ...
    i.define("scroll", t.exports = function (t) {
        ...
        function p(e) {
            ...
            if (!(i.env("design") || window.$.mobile && /(?:^|\s)ui-link(?:$|\s)/.test(a.className))) {
                var c, f = (c = a, d.test(c.hash) && c.host + c.pathname === n.host + n.pathname ? a.hash : "");
                if ("" !== f) {
                    var h = t(f);
        ...
        return {
            ready: function () {
                var t = e.WF_CLICK_EMPTY,
                    n = e.WF_CLICK_SCROLL;
                a.on(n, h, p), a.on(t, f, function (t) {
                    t.preventDefault()
                })
            }
        }
    ...
    r.define("forms", t.exports = function (t, e) {
        ...
        function y(e, n) {
                ...
                ! function (e, n) {
                    ...
                    function S(t) {
                        var i = t.responseJSON && t.responseJSON.msg,
                            r = y;
                        "string" == typeof i && 0 === i.indexOf("InvalidFileTypeError") ? r = g : "string" == typeof i && 0 === i.indexOf("MaxFileSizeError") && (r = b), d.text(r), l.removeAttr("data-value"), l.val(""), a.toggle(!1), o.toggle(!0), c.toggle(!0), n.fileUploads[e].uploading = !1, A() || x(n)
                    }
            ...
            r.handler = null, r.redirect = i.attr("data-redirect"), b.test(s) ? r.handler = z : s || (o ? r.handler = "function" == typeof hostedSubmitWebflow ? hostedSubmitWebflow : S : g())
        }
