...
function loadNextQuestion () {
    ...
    const lowestCategory = Math.min(awarenessDigit, engagementDigit, conversionDigit, retentionDigit);
    ...
    if(currentQuestion == totalQuestions) {
        ...
        result.innerHTML =
         `<h1 class="results-heading">Your score: ${totalScore}</h1>
         <div class="summary">
            <h1>Here are your results:</h1>
            <p>awareness is ${awarenessDigit}, engagement is ${engagementDigit} conversion is ${conversionDigit} retention is ${retentionDigit}</p>
            <p>Your lowest value was within the ${lowest.name} marketing pillar.</p>
            <p>${lowest.string}</p>
